...
import com.snailscoder.system.wrapper.MenuWrapper;
...
public class MenuController extends SnailController {
	...
	public R<List<MenuVO>> routes(LoginUser user) {
	...
	public R<List<MenuVO>> grantTree(LoginUser user) {
