...
public class TokenUtil {
	...
	public static AuthInfo createAuthInfo(UserInfo userInfo) {
		...
		param.put(TokenConstant.TENANT_ID, SecureUtil.getTenantId());
	...
	private static TokenInfo createRefreshToken(UserInfo userInfo) {
		...
		param.put(TokenConstant.USER_ID, Func.toStr(user.getId()));
		param.put(TokenConstant.OAUTH_ID, Func.toStr(userInfo.getOauthId()));
